            ...
            <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 font-medium">Selecione o que você gosta de comer.</p>
                    </div>
                                ...
                                {section.options.map((opt) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className={`font-bold ${isSelected ? 'text-brand-700' : 'text-gray-700'}`}>
                                                    {opt.label}
                                                </p>
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50 flex gap-4">
                    ...
                    <button
                        ...
                        className="flex-1 py-3 bg-brand-600 text-white font-bold rounded-xl shadow-lg shadow-brand-200 hover:bg-brand-700 hover:scale-[1.02] active:scale-100 transition-all flex items-center justify-center gap-2"
                    >
